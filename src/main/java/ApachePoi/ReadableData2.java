package ApachePoi;
	...
	public class ReadableData2 {

		public static void main(String[] args) throws Exception {
			
			FileInputStream fi = new FileInputStream("C:\\Users\\Asus\\eclipse-workspace\\FrameWorkDesign\\ExcelSheets\\Lowerversion.xls");
			...
			FileOutputStream fo = new FileOutputStream("C:\\Users\\Asus\\eclipse-workspace\\FrameWorkDesign\\ExcelSheets\\LowerResults.xls");
			Workbook1.write(fo);
			fi.close();
			Workbook1.close();
